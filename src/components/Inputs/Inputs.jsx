  ...
  return (
    ...
    >
      ...
      <TextField
        ...
        sx={{ m: 1, border: errors?.username ? "2px solid #d32f2f" : "none" }}
        InputProps={{
          startAdornment: (
            <InputAdornment position="start">
              <PermIdentityOutlinedIcon sx={{ color: "#000", fill: "white" }} />
            </InputAdornment>
          ),
        }}
      />
      ...
      <TextField
        ...
        sx={{ m: 1, border: errors?.password ? "2px solid #d32f2f" : "none" }}
        InputProps={{
          endAdornment: (
            <InputAdornment
              position="end"
          ...
          startAdornment: (
            <InputAdornment position="start" sx={{ width: "62px" }}>
